...
/**
 * REST controller for managing {@link org.zdar.domain.Job}.
 */
@RestController
@RequestMapping("/api")
public class JobResource {
    ...
    public ResponseEntity<List<JobDTO>> searchJobs(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
