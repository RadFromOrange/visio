...
/**
 * REST controller for managing {@link org.zdar.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    public ResponseEntity<List<JobHistoryDTO>> searchJobHistories(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
